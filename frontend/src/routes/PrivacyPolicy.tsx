const PrivacyPolicy = () => {
  return (
    <div className="flex justify-center min-h-screen py-12 bg-gray-100">
      <div className="w-full max-w-4xl p-8 mx-4 bg-white rounded-lg shadow-lg md:p-12">
        ...
        <p className="mb-4 text-gray-600">Last updated: August 04, 2025</p>
        ...
        <h3 className="mt-6 mb-3 text-xl font-medium text-gray-700">
          Interpretation
        </h3>
        <p className="mb-4 leading-relaxed text-gray-600">
        ...
        <ul className="pl-6 space-y-3 text-gray-600 list-disc">
          ...
          <li>
            ...
            &quot;Our&quot; in this Agreement) refers to YouPipe.
          </li>
          <li>
        ...
        <h4 className="mt-5 mb-2 text-lg font-medium text-gray-700">
          Personal Data
        </h4>
        <p className="mb-4 leading-relaxed text-gray-600">
