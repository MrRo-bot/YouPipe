    ...
    <>
      <AnimatePresence>
        <motion.div
          ...
          className="relative mb-2 mt-3 max-h-[90vh] mx-auto w-2/3 overflow-y-auto hideScrollbar"
        >
          <h1 className="text-4xl font-bold">Watch history</h1>
          <div className="mt-10 mb-5 text-xl font-semibold max-w-max">
            Today
          </div>
      ...
      <div className="fixed right-[15%] top-[25%]">
