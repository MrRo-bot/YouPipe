  ...
  return (
    <div className="w-full overflow-y-auto hideScrollbar">
      <div className="relative mb-2 mt-3 w-[60%] max-h-[90vh] rounded-xl mx-auto">
        <h1 className="py-4 text-4xl font-bold ">All Subscriptions</h1>
        <div className="flex items-center gap-2 px-2 py-1 my-2 bg-gray-800 rounded-md cursor-pointer max-w-max">
