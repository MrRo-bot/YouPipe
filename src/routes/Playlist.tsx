  ...
  return (
    ...
    >
      <motion.h1
        ...
        className="px-2.5 text-xl font-bold tracking-tight md:px-2 sm:text-2xl md:text-3xl lg:text-4xl text-slate-200"
      >
        My Custom Playlists
      </motion.h1>

      <div className="grid grid-flow-row p-2 mt-2 md:mt-5 gap-x-2 gap-y-4 md:gap-x-4 md:gap-y-6 xl:gap-x-6 xl:gap-y-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
