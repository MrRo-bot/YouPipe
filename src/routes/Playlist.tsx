...
const Playlist = () => {
  return (
    <div className="relative mb-2 mt-3 max-h-[90vh] rounded-xl mx-4 w-full overflow-y-auto hideScrollbar">
      <h1 className="px-2 text-4xl font-bold">Playlists</h1>
      <div className="flex items-center gap-2 p-2 mx-2 my-5 font-semibold bg-gray-800 rounded-md cursor-pointer max-w-max">
