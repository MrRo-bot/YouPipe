...
const Sidebar = () => {
  return (
    <aside className="flex flex-col pr-2">
      <div className="flex flex-col pt-3 pl-4 pb-3 pr-0 border-zinc-400 border-solid border-b-[1px]">
        <div className="flex items-center gap-6 px-3 py-1.5 rounded-xl hover:bg-zinc-100 focus:bg-zinc-100 cursor-pointer">
      ...
      <div className="flex flex-col pt-3 pb-3 pl-4 pr-0">
        <div className="flex items-center gap-6 px-3 py-1.5 rounded-xl hover:bg-zinc-100 focus:bg-zinc-100 cursor-pointer">
